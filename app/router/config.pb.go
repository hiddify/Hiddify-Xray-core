...
type BalancingOptimalStrategyConfig struct {
	...
	AcceptLittleDiff bool       `protobuf:"varint,5,opt,name=accept_little_diff,json=acceptLittleDiff,proto3" json:"accept_little_diff,omitempty"`
	DiffPercent      float64    `protobuf:"fixed64,6,opt,name=diff_percent,json=diffPercent,proto3" json:"diff_percent,omitempty"`
	LoadBalancing    bool       `protobuf:"varint,7,opt,name=load_balancing,json=loadBalancing,proto3" json:"load_balancing,omitempty"`
	Weights          []*Weights `protobuf:"bytes,8,rep,name=weights,proto3" json:"weights,omitempty"`
}
...
func (x *BalancingOptimalStrategyConfig) GetAcceptLittleDiff() bool {
	if x != nil {
		return x.AcceptLittleDiff
	}
	return false
}

func (x *BalancingOptimalStrategyConfig) GetDiffPercent() float64 {
	if x != nil {
...
func (x *BalancingOptimalStrategyConfig) GetLoadBalancing() bool {
	if x != nil {
...
type BalancingRule struct {
	...
	OptimalStrategyConfig *BalancingOptimalStrategyConfig `protobuf:"bytes,6,opt,name=optimal_strategy_config,json=optimalStrategyConfig,proto3" json:"optimal_strategy_config,omitempty"`
}
